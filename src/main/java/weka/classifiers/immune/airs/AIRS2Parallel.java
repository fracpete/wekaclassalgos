	...
	implements OptionHandler, AIRSParameterDocumentation
{
	...
	public String totalResourcesTipText(){return DESCRIPTIONS[4];}
	public String stimulationValueTipText(){return DESCRIPTIONS[5];}
	// int
	public String numInstancesAffinityThresholdTipText(){return DESCRIPTIONS[6];}
	public String memInitialPoolSizeTipText(){return DESCRIPTIONS[7];}
	public String knnTipText(){return DESCRIPTIONS[8];}
	public String numThreadsTipText(){return DESCRIPTIONS[9];}
	public String mergeModeTipText(){return DESCRIPTIONS[10];}
	...
	public static void main(String[] argv)
	{
		...
		try
		{
			System.out.println(Evaluation.evaluateModel(new AIRS2Parallel(), argv));
		}
		catch (Exception e)
		{
