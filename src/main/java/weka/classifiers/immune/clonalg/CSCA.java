...
public class CSCA extends Classifier implements OptionHandler
{
    ...
    public String minimumFitnessThresholdTipText(){return DESCRIPTIONS[4];}    
    public String kNNTipText(){return DESCRIPTIONS[5];}
    public String numPartitionsTipText(){return DESCRIPTIONS[6];}
