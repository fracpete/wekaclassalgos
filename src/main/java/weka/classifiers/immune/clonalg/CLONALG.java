...
public class CLONALG extends Classifier implements OptionHandler
{
    ...
    public String clonalFactorTipText(){return DESCRIPTIONS[0];}    
    public String antibodyPoolSizeTipText(){return DESCRIPTIONS[1];}
    public String selectionPoolSizeTipText(){return DESCRIPTIONS[2];}
    public String totalReplacementTipText(){return DESCRIPTIONS[3];}
    public String numGenerationsTipText(){return DESCRIPTIONS[4];}    
    public String seedTipText(){return DESCRIPTIONS[5];}
    public String remainderPoolRatioTipText(){return DESCRIPTIONS[6];}
