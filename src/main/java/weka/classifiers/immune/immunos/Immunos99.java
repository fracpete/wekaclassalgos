...
public class Immunos99 extends AbstractClassifier
{
    ...
    public String totalGenerationsTipText(){return DESCRIPTIONS[0];}
    public String seedTipText(){return DESCRIPTIONS[1];}
    public String minimumFitnessThresholdTipText(){return DESCRIPTIONS[2];}    
    public String seedPopulationPercentageTipText(){return DESCRIPTIONS[3];}    
